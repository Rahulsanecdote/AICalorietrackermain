...
const budgets = [
  ...
  { name: "styles", pattern: /^index-.*\.css$/, maxGzipKb: 18.5 },
  ...
  { name: "dashboard-analytics", pattern: /^AnalyticsDashboard-.*\.js$/, maxGzipKb: 6.2 },
  ...
  { name: "dashboard-meal-plan", pattern: /^MealPlanGenerator-.*\.js$/, maxGzipKb: 10.2 },
